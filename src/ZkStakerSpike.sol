...
// "staker/calculators/IdentityEarningPowerCalculator.sol";
...
//   // TODO: add a `_alterClaimer` method that updates `validatorForAtomicEarningPowerCalculation`.
//   // TODO: add a `_claimReward` method that updates `validatorForAtomicEarningPowerCalculation`.
//   // TODO: add a `bumpEarningPower` method that updates
...
//     if (_isEmptyBLS12_381PublicKey(_validatorPubKey) ||
// _isEmptyBLS12_381Signature(_validatorPoP)) {
//       // TODO: add custom error
//       revert();
//     }

//     // Store the keys in the registeredValidators mapping
//     registeredValidators[msg.sender] = ValidatorKeys({pubKey: _validatorPubKey, pop:
// _validatorPoP});
...
//       registry.add(msg.sender, isLeaderDefault, uint32(_weight), _validatorPubKey,
// _validatorPoP);
//     }
//   }
...
//   // get
//   // the deposit's validator out of storage, put it into the temp variable, call the super
// // method,
...
//   // TODO: Calculate the newWeight inside this function instead of passing it in.
//   function _changeValidatorWeight(address _validatorOwner, uint256 _newWeight) internal virtual {
//     if (!isValidatorRegistered(_validatorOwner)) return;
...
//       registry.add(_validatorOwner, isLeaderDefault, uint32(_newWeight), _keys.pubKey,
// _keys.pop);
//     }

//     // they're not in the registry. Should we change the weight before removing the validator?
//     if (_isInRegistry) {
//       if (!_isAboveThreshold) registry.remove(_validatorOwner);
//       else registry.changeValidatorWeight(_validatorOwner, uint32(_newWeight));
//     }
//   }
